...
<div class="fh5co-cover" data-stellar-background-ratio="0.5" style="background-image: url(<?php echo base_url() ?>_assets/images/bg3.png)">
		<div class="desc">
			<div class="container">
				<div class="row">
				<div class="desc2 animate-box">
						<div class="col-sm-7 col-sm-push-1 col-md-7 col-md-push-1">
							...
							<h2><i class="icon-airplane"></i> DanTravel</h2>
							<h3>Nikmati Perjalanan Anda </h3>
							<span class="price">Selamat Berlibur</span>
