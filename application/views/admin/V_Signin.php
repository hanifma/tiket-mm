...
<link rel="stylesheet" href="<?php echo base_url() ?>_assets/css/main_style.css">
	...
	<header id="fh5co-header-section" class="sticky-banner">
		<div class="container">
			<div class="nav-header">
				...
				<h1 id="fh5co-logo"><a href="<?php echo base_url() ?>"><img src="images/departure.png" alt=""></i>HF FLIGHTS</a></h1>
