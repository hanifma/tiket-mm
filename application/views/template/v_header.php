...
<!DOCTYPE html>
	...
	<meta name="description" content="AkhdanTravel" />
	<meta name="keywords" content="AkhdanTravel" />
	<meta name="author" content="AkhdanTravel" />
		...
		<header id="fh5co-header-section" class="sticky-banner">
			<div class="container">
				<div class="nav-header">
					...
					<h1 id="fh5co-logo"><a href="">HF FLIGHTS</a><h1>
					...
					<nav id="fh5co-menu-wrap" role="navigation">
						<ul class="sf-menu" id="fh5co-primary-menu">
							...
							<li class=""><a href="<?php echo base_url() ?>reservation">Pesananku</a></li>
							<li class="header-username"><a><?php echo $this->session->userdata('user')['username'] ?></a></li>
							<li class=""><a href="<?php echo base_url() ?>account/logout">Keluar</a></li>
							
							<?php else: ?>
							<li><a href="<?php echo base_url() ?>account/signin">Masuk</a></li>
							<li><a href="<?php echo base_url() ?>account/signup">Daftar</a></li>
							<?php endif; ?>
